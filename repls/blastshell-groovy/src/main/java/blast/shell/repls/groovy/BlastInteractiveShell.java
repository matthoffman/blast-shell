...
/**
 * basically a copy of groovy's groovy.ui.InteractiveShell, but using our version of jline, and with a few tweaks to let it work
 ...
 */
public class BlastInteractiveShell implements Runnable {
    private static final String NEW_LINE = System.getProperty("line.separator");
    private static final MessageSource MESSAGES = new MessageSource(BlastInteractiveShell.class);
     ...
     */
    public BlastInteractiveShell(final InputStream in, final PrintStream out, final PrintStream err) throws IOException {
     ...
     * @param err     The error stream to use
     */
    public BlastInteractiveShell(final Binding binding, final InputStream in, final PrintStream out, final PrintStream err) throws IOException {
     ...
     * @param err     The error stream to use
     */
    public BlastInteractiveShell(final ClassLoader parent, final Binding binding, final InputStream in, final PrintStream out, final PrintStream err) throws IOException {
        assert binding != null;
        assert in != null;
        assert out != null;
        assert err != null;
...
//        }
    ...
    private class CommandNameCompletor extends StringsCompleter {
        public CommandNameCompletor() {
            // Add each command name/alias as a candidate
            super(COMMAND_MAPPINGS.keySet());
        }
    }
