 ...
 *  </pre>
 * @Deprecated use StringsCompleter instead
...
class SimpleCompletor implements Completor, Cloneable {
   ...
   */
  public SimpleCompletor(final InputStream instream) throws IOException {
    this(getStrings(new InputStreamReader(instream)));
  }

  private static String[] getStrings(final Reader inreader)
  throws IOException {
    final Reader reader =
    (inreader instanceof BufferedReader) ? inreader : new BufferedReader(inreader);
